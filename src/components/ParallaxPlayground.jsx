...
import MockContentDiv from './MockContentDiv'
...
class ParallaxPlayground extends React.Component {
  render() {
    return (
      <>
        <div className="parallax-container">
          ...
          >
            ...
            <>
              {[0, 0.5, 1, 1.5, 2].map((e, i) => (
                <Fragment key={i}>
                  <ParallaxLayer offset={e}>
                    <MockContentDiv number={e} />
                  </ParallaxLayer>
                </Fragment>
              ))}
            </>
...
export default ParallaxPlayground
